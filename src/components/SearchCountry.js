...
export function SearchCountry({ setCountries, setIsCountryFounded }) {
  ...
  return (
    <section className="search">
      <svg className="search__icon" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 512 512">{/* Font Awesome Pro 6.2.0 by @fontawesome - https://fontawesome.com License - https://fontawesome.com/license (Commercial License) Copyright 2022 Fonticons, Inc.*/}
